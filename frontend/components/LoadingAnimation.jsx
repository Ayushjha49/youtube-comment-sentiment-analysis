...
const STEPS = [
  {
    ...
    sub  : 'Connecting to YouTube Data API v3',
    color: '#6c63ff',
    delay: 0,
  },
  {
    id   : 'clean',
    icon : '🧹',
    label: 'Cleaning & normalizing data',
    sub  : 'Handling Romanized Nepali/Hindi + English',
    color: '#4ecdc4',
    delay: 1200,
  },
  {
    ...
    sub  : 'BiLSTM + Attention · ML Ensemble',
    color: '#f0b429',
    delay: 2400,
  },
  {
    ...
    sub  : 'Computing distribution & statistics',
    color: '#00e5a0',
    delay: 3600,
  },
]
  ...
  return (
    <div className="absolute inset-0 overflow-hidden rounded-2xl pointer-events-none">
      <svg className="absolute inset-0 w-full h-full opacity-10" viewBox="0 0 400 300">
        ...
        {[
          [60,60], [60,150], [60,240],
          [160,40], [160,110], [160,190], [160,260],
          [260,70], [260,150], [260,230],
          [340,100], [340,200],
        ].map(([x, y], i) => (
        ...
        {/* Connections */}
        {[
          [60,60,160,40], [60,60,160,110], [60,150,160,110], [60,150,160,190],
          [60,240,160,190], [60,240,160,260], [160,40,260,70], [160,110,260,70],
          [160,110,260,150], [160,190,260,150], [160,190,260,230], [160,260,260,230],
...
export default function LoadingAnimation({ videoUrl }) {
  ...
  useEffect(() => {
    ...
    STEPS.forEach((step, i) => {
      const timer = setTimeout(() => {
        setActiveStep(i)
        if (i > 0) {
          setCompletedSteps(prev => [...prev, STEPS[i-1].id])
        }
      }, step.delay)
  ...
  return (
    <div className="glass-card relative overflow-hidden p-8 w-full max-w-2xl mx-auto animate-slide-up">
      ...
      <div className="relative z-10 text-center mb-8">
        ...
        {videoUrl && (
          <p className="font-mono text-xs text-white/30 truncate max-w-xs mx-auto">
            {videoUrl}
          </p>
        )}
      </div>
      ...
      <div className="relative z-10 space-y-2">
        {STEPS.map((step, i) => {
          ...
          const isPending = activeStep < i && !isDone
      ...
      <div className="relative z-10 mt-6">
        <div className="progress-bar-track">
          <div
            ...
            style={{
              width: `${Math.min(100, ((activeStep + 0.7) / STEPS.length) * 100)}%`,
        ...
        <div className="flex justify-between mt-2 font-mono text-xs text-white/20">
          ...
          <span>{Math.round(((activeStep + 0.7) / STEPS.length) * 100)}%</span>
        </div>
      </div>
